...
const ReportIssuePage: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="mb-8 p-6 rounded-xl border border-rose-100 bg-rose-50/50 dark:bg-rose-950/20 dark:border-rose-900/30 shadow-sm">
        <div className="flex items-start gap-4">
          <div className="p-2 rounded-lg bg-rose-500 text-white shadow-md">
            <AlertCircle className="h-6 w-6" />
          </div>
          <div>
            <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 tracking-tight">Encountered a problem?</h2>
      ...
      <div className="p-8 rounded-xl border border-slate-200 dark:border-surface-400 bg-white dark:bg-surface-500 shadow-sm">
        <div className="space-y-6">
          <div>
            <h3 className="text-sm font-bold flex items-center gap-2 text-slate-900 dark:text-slate-100 mb-2 uppercase tracking-wider">
            ...
            <div className="rounded-lg bg-slate-50 dark:bg-surface-400 p-4 border border-slate-100 dark:border-surface-300">
              <p className="text-sm font-bold text-slate-700 dark:text-slate-100">Document Workflow Support</p>
          ...
          <div className="pt-8">
            <button 
               ...
               className="w-full h-11 flex items-center justify-center rounded-xl bg-brand-500 text-white font-bold text-sm shadow-lg shadow-brand-500/20 hover:bg-brand-600 transition-all active:scale-[0.98]"
            >
