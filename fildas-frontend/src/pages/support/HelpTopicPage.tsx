...
const TOPICS: Record<string, TopicData> = {
  "getting-started": {
    ...
    description: "Understand the basics of FilDOCS and set up your workspace.",
    icon: BookOpen,
    iconBg: "bg-sky-100 dark:bg-sky-950/30",
    iconColor: "text-sky-600 dark:text-sky-400",
    articles: [
      {
        title: "What is FilDOCS?",
        content: (
          <div className="space-y-3">
            <p>
              FilDOCS (Filamer Document Operations and Control System) is a comprehensive workflow engine designed to manage official documents from creation through formal distribution.
            </p>
