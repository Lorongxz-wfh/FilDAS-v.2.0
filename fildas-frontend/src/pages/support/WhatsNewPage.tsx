...
const STATIC_RELEASES: Release[] = [
  ...
  },
  {
    ...
    date: "November 2025",
    items: [
      { tag: "New", text: "FilDOCS v2 — full platform rewrite with a new React + TypeScript + Tailwind frontend and Laravel backend." },
...
const STORAGE_KEY = "fildocs_custom_releases";
