...
const MyWorkQueuePage: React.FC = () => {
  ...
  const handleDocumentSelect = (id: number) => {
    navigate(`/documents/${id}`, { state: { from: "/work-queue" } });
  };
  ...
  return (
    ...
    >
      ...
      <Card className="overflow-hidden">
        <CardBody className="bg-white p-0 dark:bg-surface-500">
          <div className="grid grid-cols-1 divide-y divide-slate-100 md:grid-cols-3 md:divide-y-0 md:divide-x dark:divide-surface-400">
              ...
              <div className="space-y-2">
                {recentActivity.slice(0, 5).map((l: any) => (
                  <button
                    ...
                    className="w-full text-left rounded-xl border border-slate-200 bg-white px-3 py-2 hover:bg-slate-50 dark:border-surface-400 dark:bg-surface-600 dark:hover:bg-surface-400"
                  >
