  ...
  return (
    <div className="flex items-center gap-1.5 flex-1">
      <input
        ...
        disabled={saving}
        className="flex-1 rounded-md border border-sky-400 bg-white dark:bg-surface-600 px-2 py-1 text-sm font-bold text-slate-900 dark:text-slate-100 outline-none focus:ring-2 focus:ring-sky-100 dark:focus:ring-sky-900/30 transition disabled:opacity-50"
      />
      <button
        type="button"
        onClick={save}
