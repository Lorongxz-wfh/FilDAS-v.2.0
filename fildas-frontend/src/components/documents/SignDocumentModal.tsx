...
const SignDocumentModal: React.FC<SignDocumentModalProps> = ({
  open,
  onClose,
  documentVersionId,
  signatureUrl,
  ...
  const renderPageRef = useRef<((doc: any, pageIndex: number) => Promise<void>) | null>(null);
  renderPageRef.current = async (doc: any, pageIndex: number) => {
    try {
